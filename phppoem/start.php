...
define('CORE_PATH'  , realpath(POEM_PATH.'core').'/'); // phppoem核心代码库
define('VENDOR_PATH', POEM_PATH.'vendor/');  // 扩展包库
define('CORE_CONF'  , POEM_PATH.'config.php'); // 配置文件
define('CORE_FUNC'  , POEM_PATH.'function.php'); // 公共函数
define('APP_CONF'   , APP_PATH.'config.php');
